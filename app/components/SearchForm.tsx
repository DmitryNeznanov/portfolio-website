...
export default function SearchForm({ data }: { data: Post[] }) {
  ...
  return (
          ...
          <div className="flex flex-row items-center justify-between">
            <div className="w-[90%] bg-[#282828] rounded-full p-[16px] ">
              <input
                ...
                type="text"
                placeholder="Enter information from the blog or its ID"
                id="searchInput"
                onChange={(e) => {
	...
	489.292,457.678 277.331,245.004 489.292,32.337 "
          ...
          <section className="mt-[64px] lg:mt-[128px] px-[16px] py-[32px] bg-[#282828] rounded-tl-[32px] rounded-bl-[32px] overflow-x-auto max-h-[70vh] overflow-scroll h-full">
            <div
            ...
            >
              ...
              >
                {filteredData.length === 0 ? (
                  <div>
                    <h2 className="h2-ubuntu text-jade">
